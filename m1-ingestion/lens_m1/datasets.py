...
ENTITIES: list[Entity] = [
    ...
    # Vortex group — NBFI — UBO aggregation breach (Archegos-shaped); HK cluster
    Entity("LE-0020", "Vortex Global Holdings Ltd", "nbfi", FIN, country="HK", rating="BB"),
    Entity(
        "LE-0021",
        "Vortex Alpha Fund Ltd",
        "nbfi",
        FIN,
        parent_id="LE-0020",
        country="HK",
    ...
    Entity("LE-0030", "Nimbus Capital Partners Ltd", "nbfi", FIN, country="SG", rating="BB"),
    Entity(
        "LE-0031",
        "Pinnacle Developments Ltd",
        "corporate",
        CRE,
    ...
    # Standalone names (sector + country spread + CR10 tail + government)
    Entity(
        "LE-0040",
        "Orion Estates Ltd",
        "corporate",
    ...
    Entity("LE-0042", "Sirius Public Authority", "government", GOV, country="SG", rating="AAA"),
    Entity(
        "LE-0043",
        "Castor Health Ltd",
        "corporate",
    ...
    Entity("LE-0046", "Lyra Capital Ltd", "nbfi", FIN, country="SG", rating="BB"),
    Entity(
        "LE-0047",
        "Draco Industrial Ltd",
        "corporate",
        INDUS,
    ...
    Entity(
        ...
        "corporate",
        CONSUMER,
        annual_revenue=11_000_000,
        country="SG",
        rating="BBB",
    ),
    Entity(
        "LE-0051",
        "Cobalt Materials Ltd",
        "corporate",
        INDUS,
